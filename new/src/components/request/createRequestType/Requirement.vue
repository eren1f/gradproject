<template>
    <div class="requirements-wrapper-div">
        <div>
            ...
            <input id="name-of-req" type="text" v-model="name" @input="emitChange" class="border rounded-md p-2 mt-2 ml-5 text-black bg-gray-100 w-40 h-8" style="margin-left: 30%;">
        </div>
        <div>
        ...
        <div>
            <button @click="handleMoveUp" class="text-white bg-blue-500 hover:bg-blue-700 px-4 py-2 rounded-md mb-4 w-36 h-10">Move up &uarr;</button>
            <button @click="handleMoveDown" class="text-white bg-blue-500 hover:bg-blue-700 ml-10 px-4 py-2 rounded-md w-36 h-10">Move down &darr;</button>
        </div>
        <div>
